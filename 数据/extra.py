...
def getScore(keyword_index):
	...
	for key, value in keyword_index.items():
		new_value = {}
		totalScore = 0.0
		writeComment(value, u"./腾讯新增/allComments/" + key + ".txt")
...
def write2file(file_list):
	...
	for key, value in file_list.items():
		...
		table.write(line_cnt, 1, (u"腾讯").encode("gbk"))
		table.write(line_cnt, 2, value['aveScore'])
		table.write(line_cnt, 3, value['sum'])
		line_cnt += 1
	data.save(u"./腾讯新增/tencent_added.xls")


if __name__ == "__main__":
	absolute_path = u"./腾讯新增/"
	...
	out_file_1 = open(u"./腾讯新增/file_index.pkl", "w")
	pickle.dump(file_index, out_file_1)

	new_file_list = getScore(file_index)

	out_file = open(u"./腾讯新增/file_list.pkl", "w")
