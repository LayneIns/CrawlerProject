...
def getScore(file_list, index_path):
	...
	for key, value in file_list.items():
		...
		totalScore = 0.0
		writeComment(all_comments, u"./爱奇艺/allComments/" + key + ".txt")
		for comment in all_comments:
...
def write2file(file_list):
	...
	for key, value in file_list.items():
		...
		table.write(line_cnt, 2, (u"爱奇艺").encode("gbk"))
		table.write(line_cnt, 3, value['aveScore'])
		table.write(line_cnt, 4, value['sum'])
		line_cnt += 1
	data.save(u"./爱奇艺/iqiyi.xls")


if __name__ == "__main__":
	index_path = u"./爱奇艺/new_data/"
	...
	out_file = open(u"./爱奇艺/file_list.pkl", "w")
